...
bucket = storage_client.bucket("practice-bucket-mlops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "big-query-practice-412523.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://practice-bucket-mlops/data/bank-additional.csv"
    model_name='xgboost'
